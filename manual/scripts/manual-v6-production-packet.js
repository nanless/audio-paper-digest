...
if (require.main === module) {
    require('../../scripts/env-loader.js').requireExternalRuntime('manual-v6-production-packet.js');
}
const Config = require('../../scripts/config.js');
const { DOCUMENT_TYPES, normalizedId, writeFileAtomic } = require('../../scripts/utils.js');
const {
