...
class SealedTutorialPreviewTest(unittest.TestCase):
    def make_fixture(self):
        ...
        controlled = {
            ...
            'editorialContract': ROOT / 'prompts' / 'manual-tutorial-article.md',
            'referenceContract': ROOT / 'docs' / 'manual-editorial-reference-contract.md',
            'qualitySchema': ROOT / 'scripts' / 'manual-tutorial-quality-contract.js',
        }
        manifest = {
            'version': 5,
