...
const bundle=JSON.parse(fs.readFileSync('data/current/manual-v6/2026-08-29/task-runner/tasks/2608.26925/draft/author-record.json','utf8')).editorial.longformBundle;
const article=JSON.parse(fs.readFileSync('data/current/manual-v6/2026-08-29/task-runner/tasks/2608.26925/draft/author-record.json','utf8')).editorial.readerArticle;
