...
if (require.main === module) {
    require('./env-loader.js').requireExternalRuntime('manual-tutorial-artifacts.js');
}
...
function parseCli(argv) {
    ...
    if (position < 0 || !args[position + 1] || args.length !== validLength
        ...
        throw new Error('用法: node scripts/manual-tutorial-artifacts.js --artifact <ArtifactIndex.json> [--output <artifact-plan.json>]');
    }
    return {
