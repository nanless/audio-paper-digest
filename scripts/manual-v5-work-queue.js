...
if (require.main === module) require('./env-loader.js').requireExternalRuntime('manual-v5-work-queue.js');
    ...
    for (const paperId of ids) {
        ...
        const authorTask = materializeTask({
            ...
            packet: {
                ...
                command: `npm run manual:author-packet -- --date ${date} --paper ${paperId}`,
